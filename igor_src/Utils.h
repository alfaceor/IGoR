...
enum Fileformat{CSV_f, FASTA_f, TXT_f, FASTQ_f, TSV_f};
...
// TODO: Find a more efficient way to make a translation "hash functions are computationally intensive and since here the number of entries (the codon alphabet) is fixed an array inside a struct/class could be faster." qmarcou
